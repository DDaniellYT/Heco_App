...
const StorageSpace = (props)=>{
    ...
    return <div className={styles.storageSpaceContainer}>
        ...
        {addItem?<AddItemPanel user={props.user} hall={props.storageSpace} setAddItem={setAddItem} ipOfServer={props.ipOfServer} change={props.change} setChange={props.setChange} httpPort={props.httpPort}/>:null}
